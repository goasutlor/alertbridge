...
const LANG = {
  en: {
    ...
    dlqSub: "Summary table of recent failed forwards; use Show to expand full JSON from the DLQ file. Requires Basic Auth.",
    ...
    dailySub: "Persisted daily counters on PVC (no details).",
  ...
  th: {
    ...
    dlqSub: "สรุปในรูปตาราง — กดแสดงเพื่อดู JSON เต็มจาก DLQ ต้องใช้ Basic Auth",
    ...
    next: "ถัดไป",
    dailyTitle: "Daily Metrics",
    dailySub: "ตัวนับรายวันแบบถาวรบน PVC (ไม่มีรายละเอียดราย event)",
