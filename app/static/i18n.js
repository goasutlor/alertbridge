...
const LANG = {
  en: {
    ...
    manual: "Manual — Select template (OCP) or \"Custom (paste example log)\" and paste JSON",
  ...
  th: {
    ...
    manual: "กำหนดเอง (Manual) — เลือก template (OCP) หรือ \"Custom (paste example log)\" แล้ววาง JSON เอง",
