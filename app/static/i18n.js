...
const LANG = {
  en: {
    ...
    targetOk: "●",
    targetFail: "●",
    logSearchTitle: "Log archive search",
    logSearchSub: "Search application logs when a log store is connected — stays inside this portal.",
    logSearchOff: "Log search is not configured. Set ALERTBRIDGE_LOKI_URL and stream labels on the Deployment.",
    logSearchLogin: "Sign in with Basic Auth (browser prompt) to use log search.",
    logSearchHours: "Range",
    logSearchEvent: "Filter",
    logSearchLimit: "Max lines",
    logSearchPlaceholder: "Optional: request_id, route, text…",
    logSearchBtn: "Search",
    logSearchVerify: "Verify stream",
    logSearchVerifyDone: "Diagnose ready — see JSON below.",
    logSearchEvAll: "All lines",
    logSearchEvErr: "Forward errors",
    logSearchEvReq: "HTTP requests",
    logSearchLoading: "Searching…",
    logSearchDone: "Done.",
    logSearchNoResults: "No log lines matched.",
    logSearchHintStream: "Stream",
    statusIncomingShort: "Incoming",
    statusForwardShort: "Forward",
    statusLogShort: "Log archive",
    statusUnknown: "unknown",
    statusIncomingChecking: "Incoming: …",
    statusForwardChecking: "Forward: …",
    statusLogChecking: "Log archive: …",
  },
  th: {
    ...
    targetOk: "●",
    targetFail: "●",
    logSearchTitle: "ค้นหา Log ย้อนหลัง",
    logSearchSub: "ค้นหา log ของแอปเมื่อเชื่อม log store แล้ว — ใช้งานภายใน Portal นี้",
    logSearchOff: "ยังไม่ได้ตั้งค่า Log search กรุณาตั้ง ALERTBRIDGE_LOKI_URL และ label บน Deployment",
    logSearchLogin: "ต้องลงชื่อเข้าใช้ด้วย Basic Auth ก่อน (เบราว์เซอร์จะถาม)",
    logSearchHours: "ช่วงเวลา",
    logSearchEvent: "ตัวกรอง",
    logSearchLimit: "จำนวนบรรทัดสูงสุด",
    logSearchPlaceholder: "ไม่บังคับ: request_id, route, ข้อความ…",
    logSearchBtn: "ค้นหา",
    logSearchVerify: "ตรวจสอบสาย log",
    logSearchVerifyDone: "วินิจฉัยแล้ว — ดู JSON ด้านล่าง",
    logSearchEvAll: "ทุกบรรทัด",
    logSearchEvErr: "Forward ล้มเหลว",
    logSearchEvReq: "HTTP requests",
    logSearchLoading: "กำลังค้นหา…",
    logSearchDone: "เสร็จแล้ว",
    logSearchNoResults: "ไม่พบ log ที่ตรงเงื่อนไข",
    logSearchHintStream: "Stream",
    statusIncomingShort: "รับเข้า",
    statusForwardShort: "Forward",
    statusLogShort: "คลัง log",
    statusUnknown: "ไม่ทราบสถานะ",
    statusIncomingChecking: "รับเข้า: …",
    statusForwardChecking: "Forward: …",
    statusLogChecking: "คลัง log: …",
  },
};
