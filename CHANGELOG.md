...
- **SBOM:** Committed CycloneDX 1.6 JSON (`sbom/cyclonedx.json`) from a resolved `pip freeze` after `requirements.txt` install; `sbom/README.md` and `scripts/generate-sbom.{sh,ps1}` to regenerate.
